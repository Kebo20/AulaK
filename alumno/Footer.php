...
<script src="../app-assets/js/scripts/pages/app-todos.js"></script>

<script src="https://use.fontawesome.com/10cad79a24.js"></script>
<script src="../app-assets/js/scripts/animation/animation.js"></script>
 ...
 <script src="../app-assets/js/scripts/extensions/ex-component-swiper.js"></script>
    <!-- END: Page Vendor JS-->