...
function Listar(pagina) {
    ...
    $.ajax({
        ...
        url: 'controlador/Ccontabilidad.php?op=LIS_TIPO_AUX&q=' + $("#buscar").val() + "&pagina=" + pagina,
        type: "POST",
        dataType: "json",
        ...
        success: function (data) {
            ...
            $.each(data, function (key, val) {
                ...
                $("#lista").append("<tbody>");
                $("#lista").append("<tr>");
                $("#lista").append("<td width='10%'>" + val[0] + "</td>");
                $("#lista").append("<td width='30%'>" + val[1] + "</td>");
                $("#lista").append("<td width='40%'>" + val[2] + "</td>");
                $("#lista").append("<td width='20%'>" + val[3] + "</td>");
            ...
            $.ajax({
                ...
                url: 'controlador/Ccontabilidad.php?op=PAG_TIPO_AUX&q=' + $("#buscar").val(),
                type: "POST",
                dataType: "json",
...
function editar($id) {
    $.post("controlador/Ccontabilidad.php?op=LLENAR_TIPO_AUX", { id: $id }, function (data) {
        console.log(data);
        $("#valor").val("2")
        $("#tipoAUX_id").val(data.id);
        $("#tipoAUX_codigo").val(data.codigo);
        $("#tipoAUX_nombre").val(data.nombre);
        $("#ModalRegistrar").modal("show");
...
$("#formRegistrar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Ccontabilidad.php?op=NUEVO_TIPO_AUX',
        type: "POST",
        data:  $(this).serialize(),
...
$("#formEliminar").on("submit", function (e) {
    ...
    $.ajax({
        ...
        url: 'controlador/Ccontabilidad.php?op=ELIMINAR_TIPO_AUX',
        type: "POST",
